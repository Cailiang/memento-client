...
const api: MementoApi = {
  ...
  copyOverviewProcessName: (name) => ipcRenderer.invoke('memento:overview:process-copy-name', name),
  copyOverviewProcessPid: (pid) => ipcRenderer.invoke('memento:overview:process-copy-pid', pid),
  terminateOverviewProcess: (input) => ipcRenderer.invoke('memento:overview:process-terminate', input),
  ...
  listMaintenanceRuns: () => ipcRenderer.invoke('memento:maintenance:runs:list'),
  deleteMaintenanceRuns: (runIds) => ipcRenderer.invoke('memento:maintenance:runs:delete-many', runIds),
  revealMaintenanceRecovery: (operationRecordId) => ipcRenderer.invoke('memento:maintenance:recovery:reveal', operationRecordId),
