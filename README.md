...
Background services are grouped by orphaned startup items, startup failures, high CPU, high memory, long-running processes, stale items, and other services. The health score exposes a direct “Review findings” action that opens the highest-priority available category instead of showing an ambiguous recommendation.
