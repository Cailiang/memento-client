# Memento Agent 0.6.43

## 简体中文

`0.6.43` 启用完整的 GitHub Actions 多平台发布流程，并包含近期完成的 Antigravity 协议适配与磁盘浏览连续删除修复。
...
`0.6.43` introduces a complete GitHub Actions release pipeline for every packaged platform and includes the recent Antigravity protocol and consecutive disk-browser removal fixes.
